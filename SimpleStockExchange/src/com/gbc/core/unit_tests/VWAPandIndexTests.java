...
public class VWAPandIndexTests {
	...
	public void testVWAPForStock() throws Exception 
	{
		...
		GBCCoreStaticInterface.recordTrade("AAP2", 105, true, 86);
		...
		System.out.println("IndexLevel is " + indexLevel);
		
		assertTrue(Math.abs(indexLevel - Math.pow((6190.0/60)*(43270.0/515), 0.5)) < 1E-5 );
		Thread.sleep(10);
	}
