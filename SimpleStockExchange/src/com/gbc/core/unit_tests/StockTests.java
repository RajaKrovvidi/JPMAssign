...
public class StockTests 
{
	...
	{
		//System.out.println("Testing c1 hashcode equals c1a");
		...
		//System.out.println("Testing p1 hashcode equals p1a");
		assertTrue(p1.hashCode() == p1a.hashCode());
		//System.out.println("Testing p1 hascode " + p1.hashCode() + " not equals p2 hash " + p2.hashCode());
		assertFalse(p1.hashCode() == p2.hashCode());
		//System.out.println("Testing c1 hashcode not equals p1");
		assertFalse(c1.hashCode() == p2.hashCode());
	}
	...
	public void testPERatio()
	{
		...
		assertTrue(preferredStock.peRatio(50) == (50/(preferredStock.getParValue() * preferredStock.getFixedDividend())));
	}
}
